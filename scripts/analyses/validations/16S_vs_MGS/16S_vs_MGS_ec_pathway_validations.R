...
hmp_ec_spearman_df <- rbind(hmp_ec_mgs_null, hmp_ec_picrust2_nsti2_gg_vs_mgs, hmp_ec_picrust2_nsti2_vs_mgs,
...
# Create lists of spearman correlation and accuracy metrics.
mammal_ec_spearman_df <- rbind(mammal_ec_mgs_null, mammal_ec_picrust2_nsti2_gg_vs_mgs, mammal_ec_picrust2_nsti2_vs_mgs,
...
# Create lists of spearman correlation and accuracy metrics.
ocean_ec_spearman_df <- rbind(ocean_ec_mgs_null, ocean_ec_picrust2_nsti2_gg_vs_mgs, ocean_ec_picrust2_nsti2_vs_mgs,
...
# Create lists of spearman correlation and accuracy metrics.
blueberry_ec_spearman_df <- rbind(blueberry_ec_mgs_null, blueberry_ec_picrust2_nsti2_gg_vs_mgs, blueberry_ec_picrust2_nsti2_vs_mgs,
